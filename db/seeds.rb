...
ar_basil = Harvest.create!(state: ar, produce: basil, months: ["January", "February", "March", "April", "May", "June", "July", "August" "September", "October", "November", "December"], lookup_id: 3)
az_basil = Harvest.create!(state: az, produce: basil, months: ["January", "February", "March", "April", "May", "June", "July", "August" "September", "October", "November", "December"], lookup_id: 4)
